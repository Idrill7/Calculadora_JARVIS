...
/**
 * Esta es la clase TextPrompt, la utilizo para la creacion de un placeholder dentro de las JTextField
 * 
 */
	...
	implements FocusListener, DocumentListener
{
	...
	/**
	 * Metodo que cambia la opacidad del texto 
	 *
	 *  @param valor de alpha de rango  0 - 1.0.
	 */
	 ...
	 * Metodo que cambia la opacidad del texto 
	 *
	 *  @param valor de alpha de rango 0-255
	 */
	...
	/**
	 *  Metodo que cambia el estilo de la fuente
	 *  Pueden ser:
	 *  Font.BOLD, Font.ITALIC and Font.BOLD + Font.ITALIC.
	 *
	 *  @param valor del estilo de la fuente
	 */
